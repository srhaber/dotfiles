...
var resolveComponentKey = modernRenderer._U_;
var preserveComponentEls = modernRenderer._V_;
...
function createRendererFunc(templateRenderFunc, componentProps) {
    ...
    return function renderer(input, out, renderingLogic) {
        ...
        if (isExisting === true) {
            if (!component.Q_ || !component.shouldUpdate(input, component.r_)) {
                if (customEvents) {
        ...
        if (!component) {
            ...
            componentState = component._d_ || componentState;
        }

        var templateInput = getTemplateData ? getTemplateData(componentState, input, out) : componentState || input || {};

        var componentDef = componentsContext._E_(component || fakeComponent);
        componentDef.s_ = roots;
        componentDef.h_ = fakeComponent ? null : component;
        ...
        componentDef.t = function (typeName) {
            if (typeName) {
                this.h_ = component = registry._v_(typeName, fakeComponent.id);
            }
        };
        ...
        if (customEvents && componentDef.h_) {
            if (registry._w_) {
                componentDef.w_ = customEvents;
                componentDef.k_ = scope;
            } else {
                componentDef.h_._f_(customEvents, scope);
            }
        }
