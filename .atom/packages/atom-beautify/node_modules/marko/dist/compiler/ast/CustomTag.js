...
function merge(props1, props2, context) {
    ...
    if (props1 instanceof Node) {
        ...
        if (props2 instanceof Node) {
            ...
            if (props1._arg) {
                let mergeVar = context.helper('merge');
                props1._arg = context.builder.functionCall(mergeVar, [context.builder.literal(props2), // Input props from the attributes take precedence
                props1._arg]);
                return props1;
            } else {
...
class CustomTag extends HtmlElement {
    ...
    addNestedTag(nestedTag) {
        ...
        var byNameArray = this._foundNestedTagsByName[tagName] || (this._foundNestedTagsByName[tagName] = []);
    ...
    generateCode(codegen) {
            ...
            if (checkIfNestedTagCanBeAddedDirectlyToInput(this, parentCustomTag)) {
                ...
                if (tagDef.isRepeated) {
                    ...
                    if (currentValue) {
                        ...
                        parentCustomTag.setAttributeValue(tagDef.targetProperty, builder.literal([inputProps]));
                    }
                } else {
        ...
        if (bodyOnlyIf && renderBodyFunctionVar) {
            var ifStatement = builder.ifStatement(bodyOnlyIf, [builder.functionCall(renderBodyFunctionVarIdentifier, [builder.identifierOut()])], builder.elseStatement([finalNode]));
